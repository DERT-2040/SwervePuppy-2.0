...
void Code_Gen_Model_step(void)
{
  ...
  switch (i) {
   ...
   case 2:
    ...
    if (rt_hypotd_snf(Code_Gen_Model_U.Steer_Joystick_X,
      ...
      rtb_Init = Code_Gen_Model_U.Steer_Joystick_X;
    } else {
     ...
     */
    if (rtb_Init == 0.0 && rtb_POSEexponentialmatrixfori_0 == 0.0) {
    ...
    rtb_Steer_Joystick_X_Rel_Mod = look1_binlcpw
      (Code_Gen_Model_U.Drive_Joystick_X, Code_Gen_Model_ConstP.pooled7,
       Code_Gen_Model_ConstP.pooled6, 20U);
    ...
    rtb_Init = look1_binlcpw(Code_Gen_Model_U.Drive_Joystick_Y,
      Code_Gen_Model_ConstP.pooled7, Code_Gen_Model_ConstP.pooled6, 20U);
     ...
     */
    if (rtb_Steer_Joystick_X_Rel_Mod == 0.0 && rtb_Init == 0.0) {
    ...
    /* Math: '<S168>/Magnitude' */
    rtb_Magnitude = rt_hypotd_snf(rtb_Steer_Joystick_X_Rel_Mod, rtb_Init);
    ...
    if (Code_Gen_Model_DW.FixPtUnitDelay2_DSTATE_a != 0) {
      rtb_Init = rtb_Steer_Joystick_X_Rel_Mod;
    } else {
    ...
    /* Sum: '<S182>/Sum1' */
    rtb_Steer_Joystick_X_Rel_Mod -= rtb_Init;
    ...
    rtb_Add_cc = rtb_Magnitude * rtb_Init;
   ...
   *  UnitDelay: '<S114>/Unit Delay'
   */
  rtb_Init = fabs(Code_Gen_Model_B.Translation_Speed_o -
  ...
  if (rtb_AND) {
    ...
    LookUp_real_T_real_T( &(rtb_LookupTableDynamic_j), &rtb_Product7[0],
                         rtb_Init, &rtb_TmpSignalConversionAtLook_o[0], 1U);
    rtb_Init = rtb_LookupTableDynamic_j;
  } else {
    if (rtb_Compare_dh) {
    ...
    LookUp_real_T_real_T( &(rtb_LookupTableDynamic1_i), &rtb_Product7[0],
                         rtb_Init, &rtb_TmpSignalConversionAtLook_o[0], 1U);
    rtb_Init = rtb_LookupTableDynamic1_i;
  }
  ...
  /* Sum: '<S123>/Sum1' */
  rtb_POSEexponentialmatrixfori_0 = rtb_Switch2_d - rtb_Optimized_Module_Angle;

  /* Switch: '<S124>/Switch2' incorporates:
   *  RelationalOperator: '<S124>/LowerRelop1'
   */
  if (!(rtb_POSEexponentialmatrixfori_0 > rtb_uDLookupTable)) {
     ...
     *  Switch: '<S114>/Switch2'
     */
    rtb_Switch2 = rtb_Switch2_d * rtb_Init;

    /* Switch: '<S124>/Switch' incorporates:
     *  RelationalOperator: '<S124>/UpperRelop'
     */
    if (rtb_POSEexponentialmatrixfori_0 < rtb_Switch2) {
   ...
   */
  rtb_Init = (rtb_Optimized_Module_Angle - Code_Gen_Model_DW.UnitDelay1_DSTATE) *
   ...
   */
  rtb_POSEexponentialmatrixfori_0 = rtb_Init * Steering_Heading_Control_D;
   ...
   *  Store in Global RAM
   */
  rtb_Add_cc = rtb_POSEexponentialmatrixfori_0 - Code_Gen_Model_DW.UD_DSTATE_a;
  ...
  rtb_Total_Limited = (real_T)(rtb_Switch2_d == rtb_Subtract_n || fabs
    ...
    1.5707963267948966, 3.1415926535897931) - 1.5707963267948966),
                  Code_Gen_Model_ConstP.pooled13, Code_Gen_Model_ConstP.pooled12,
                  1U);
  ...
  if (rtb_Switch2_d > Steering_Motor_Control_I_UL) {
    rtb_Subtract1_o = Steering_Motor_Control_I_UL;
  } else if (rtb_Switch2_d < Steering_Motor_Control_I_LL) {
    rtb_Subtract1_o = Steering_Motor_Control_I_LL;
  } else {
    rtb_Subtract1_o = rtb_Switch2_d;
  }

  /* End of Saturate: '<S76>/Saturation1' */

  /* Sum: '<S76>/Add1' */
  rtb_Add_cc = rtb_Optimized_Module_Angle + rtb_Subtract1_o;
  ...
  Code_Gen_Model_DW.UnitDelay1_DSTATE = rtb_Init;
   ...
   *  Store in Global RAM
   */
  Code_Gen_Model_DW.UD_DSTATE_a = rtb_POSEexponentialmatrixfori_0;
  ...
  Code_Gen_Model_DW.UnitDelay_DSTATE_k = rtb_Subtract1_o;
