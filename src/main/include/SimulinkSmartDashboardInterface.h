...
class SimulinkSmartDashboardInterface {
    ...
    private:
        ...
        nt::NetworkTableEntry __Odometry_X_global_est_m__Entry;
        nt::NetworkTableEntry __Odometry_Y_global_est_m__Entry;
        nt::NetworkTableEntry __Translation_Speed__Entry;
        nt::NetworkTableEntry __Translation_Speed_o__Entry;
        ...
        nt::NetworkTableEntry __Gyro_Angle_Adjusted__Entry;
